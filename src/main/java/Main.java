...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<Producto> listaProductos = productoService.cargarListaDeProductos();

        productoService.imprimirLista(listaProductos);
        productoService.imprimirProductoMasCaro(listaProductos);
        productoService.imprimirProductoMasBarato(listaProductos);
